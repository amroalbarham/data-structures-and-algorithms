...
// return TicToc
if(TicToc[0]==TicToc[1]&&TicToc[0]==TicToc[2]&&TicToc[0]!=''){
  return true;
}else if(TicToc[3]==TicToc[4]&&TicToc[3]==TicToc[5]&&TicToc[3]!=''){return true;}
else if(TicToc[6]==TicToc[7]&&TicToc[6]==TicToc[8]&&TicToc[6]!=''){return true;}
else if(TicToc[0]==TicToc[3]&&TicToc[0]==TicToc[6]&&TicToc[0]!=''){return true;}
else if(TicToc[1]==TicToc[4]&&TicToc[1]==TicToc[7]&&TicToc[1]!=''){return true;}
else if(TicToc[2]==TicToc[5]&&TicToc[2]==TicToc[8]&&TicToc[2]!=''){return true;}
else if(TicToc[0]==TicToc[4]&&TicToc[0]==TicToc[8]&&TicToc[0]!=''){return true;}
else if(TicToc[2]==TicToc[4]&&TicToc[2]==TicToc[6]&&TicToc[2]!=''){return true;}
else return false
};
